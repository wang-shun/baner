...
insert into trans_info (TRANCODE, TRANDESC, TRAN_OPR, CHANNEL_DIY, OVERTIME, TRANFROM, TRAN_TYPE, ROUTE_TYPE) values ('chs004', '用户实名认证', 'CASHIER_CLI_chs004', null, '60000', 'CASHIER_CLI', '1', null);
