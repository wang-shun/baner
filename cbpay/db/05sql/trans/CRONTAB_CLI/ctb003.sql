...
insert into trans_info (TRANCODE, TRANDESC, TRAN_OPR, CHANNEL_DIY, OVERTIME, TRANFROM, TRAN_TYPE, ROUTE_TYPE) values ('ctb003', '账户划转报文(定时任务发起)', 'CRONTAB_CLI_ctb003', null, '60000', 'CRONTAB_CLI', '1', null);
