...
public class UserlocSqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(UserlocExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("userloc");
     ...
     * @mbg.generated
     */
    public String deleteByExample(UserlocExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("userloc");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(Userloc record) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Userloc record = (Userloc) parameter.get("record");
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(Userloc record) {
        SQL sql = new SQL();
        sql.UPDATE("userloc");
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, UserlocExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
