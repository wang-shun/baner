...
<body style="background-color: #F0F0F0; margin-left: 170px">
	...
	<div style="margin-left: 150px">
		<div id="p" class="easyui-panel" title="${luaguageBean.payresult }" iconCls="icon-ok" style="maroverflow: auto; width: 60%;height: 200px;text-align: center;">
			<div style="display:inline-block;vertical-align:middle;margin-top: 30px"><img alt="支付成功" src="img/success.png" style="height: 40px;width: 40px"></div>&nbsp;&nbsp;&nbsp;&nbsp;
			<div style="display:inline-block;vertical-align:middle;margin-top: 30px"><font size="3">${luaguageBean.success }!</font></div>
			<form  method="post">
