...
public class InContainerStartup{
	...
	String myconfig_path = config_path+File.separator+"in_conf"+File.separator;
	...
	private void init(){
		...
		System.out.println("in Container init starting ......");
		logger.info("in Container init starting...\n");
		...
		System.out.println("in Container init success in "+(endTime - startTime)+" millisecond");
		logger.info("in Container init success in "+(endTime - startTime)+" millisecond");
	}
