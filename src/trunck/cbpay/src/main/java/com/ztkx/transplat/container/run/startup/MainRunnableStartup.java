...
public class MainRunnableStartup implements Runnable{
	...
	static{
		containerMap.put("IN", "com.ztkx.transplat.container.run.startup.InContainerStartup");
		containerMap.put("OUT", "com.ztkx.transplat.container.run.startup.OutContainerStartup");
		containerMap.put("PROCESS", "com.ztkx.transplat.container.run.startup.ProcessContainerStartup");
		containerMap.put("DISCENTER", "com.ztkx.transplat.container.run.startup.DiscenterContainerStartup");
