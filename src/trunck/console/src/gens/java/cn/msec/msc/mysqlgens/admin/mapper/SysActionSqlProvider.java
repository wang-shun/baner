...
import cn.msec.msc.mysqlgens.admin.entity.SysActionExample.Criterion;
import cn.msec.msc.mysqlgens.admin.entity.SysActionExample;
import java.util.List;
import java.util.Map;

public class SysActionSqlProvider {
     ...
     */
    public String countByExample(SysActionExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("T_SYS_ACTION");
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    public String deleteByExample(SysActionExample example) {
        BEGIN();
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    public String insertSelective(SysAction record) {
        BEGIN();
        ...
        if (record.getActionMenu() != null) {
            VALUES("ACTION_MENU", "#{actionMenu,jdbcType=DECIMAL}");
        }
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    public String selectByExample(SysActionExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SysAction record = (SysAction) parameter.get("record");
        SysActionExample example = (SysActionExample) parameter.get("example");
        ...
        if (record.getActionMenu() != null) {
            SET("ACTION_MENU = #{record.actionMenu,jdbcType=DECIMAL}");
        }
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    public String updateByPrimaryKeySelective(SysAction record) {
        BEGIN();
        UPDATE("T_SYS_ACTION");
        ...
        if (record.getActionMenu() != null) {
            SET("ACTION_MENU = #{actionMenu,jdbcType=DECIMAL}");
        }
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    protected void applyWhere(SysActionExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
