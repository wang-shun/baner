...
import cn.msec.msc.mysqlgens.admin.entity.SysOpLogsExample.Criterion;
import cn.msec.msc.mysqlgens.admin.entity.SysOpLogsExample;
import java.util.List;
import java.util.Map;

public class SysOpLogsSqlProvider {
     ...
     */
    public String countByExample(SysOpLogsExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("T_SYS_OP_LOGS");
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    public String deleteByExample(SysOpLogsExample example) {
        BEGIN();
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    public String insertSelective(SysOpLogs record) {
        BEGIN();
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    public String selectByExample(SysOpLogsExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SysOpLogs record = (SysOpLogs) parameter.get("record");
        SysOpLogsExample example = (SysOpLogsExample) parameter.get("example");
        ...
        if (record.getLevel1() != null) {
            SET("LEVEL1 = #{record.level1,jdbcType=VARCHAR}");
        }
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    public String updateByPrimaryKeySelective(SysOpLogs record) {
        BEGIN();
        UPDATE("T_SYS_OP_LOGS");
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    protected void applyWhere(SysOpLogsExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
