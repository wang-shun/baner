...
import cn.msec.msc.mysqlgens.admin.entity.SysRspCodeExample.Criterion;
import cn.msec.msc.mysqlgens.admin.entity.SysRspCodeExample;
import java.util.List;
import java.util.Map;

public class SysRspCodeSqlProvider {
     ...
     */
    public String countByExample(SysRspCodeExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("T_SYS_RSP_CODE");
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    public String deleteByExample(SysRspCodeExample example) {
        BEGIN();
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    public String insertSelective(SysRspCode record) {
        BEGIN();
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    public String selectByExample(SysRspCodeExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SysRspCode record = (SysRspCode) parameter.get("record");
        SysRspCodeExample example = (SysRspCodeExample) parameter.get("example");
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    public String updateByPrimaryKeySelective(SysRspCode record) {
        BEGIN();
        UPDATE("T_SYS_RSP_CODE");
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    protected void applyWhere(SysRspCodeExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
