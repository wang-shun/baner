...
import cn.msec.msc.mysqlgens.admin.entity.TradeParamExample.Criterion;
...
public class TradeParamSqlProvider {
     ...
     */
    public String countByExample(TradeParamExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("T_TRADE_PARAM");
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    public String deleteByExample(TradeParamExample example) {
        BEGIN();
        DELETE_FROM("T_TRADE_PARAM");
        applyWhere(example, false);
        return SQL();
    }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TradeParam record = (TradeParam) parameter.get("record");
        TradeParamExample example = (TradeParamExample) parameter.get("example");
     ...
     * @mbggenerated Thu Dec 31 10:48:44 CST 2015
     */
    protected void applyWhere(TradeParamExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
