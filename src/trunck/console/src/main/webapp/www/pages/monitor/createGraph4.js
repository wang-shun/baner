var chart4;
    ...
    function query4(){
    	...
    	//var data1=Restful.find("/console/extrade100/successTradeCountByDay/"+date+",5",null);

    	//var data2=Restful.find("/console/extrade101/successTradeCountByDay/"+date+",5",null);
    	//var data3=Restful.find("/console/extrade102/successTradeCountByDay/"+date+",5",null);
    	var datas=[];
    	var count=0;
    	for(var i=0;i<3;i++){
    		var req="/console/extrade10"+i+"/successTradeCountByDay/"+date+",5";
    		$.ajax({
                type: 'get',
                url: req,
                dataType: 'json',
