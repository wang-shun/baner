var chart7;
    ...
    function query7() {
    	// var it101=Restful.find("/console/extrade101/totalShowByDay/2015-04,5",null)
    	var month = new Date().format("yyyy-MM");
    	var req="/console/extrade101/totalShowByDay/"+month+",5";
		$.ajax({
            type: 'get',
            url: req,
            dataType: 'json',
...
//    	var it102=Restful.find("/console/extrade101/totalShowByDay/2015-04-16,5",null)
