...
var chart3_2;
    ...
    function query3_1(){
    	...
    	//var data=Restful.find("/console/extrade101/tradeCountShowByDay/"+date+",5",null)

    	 $.ajax({
                type: 'get',
                url: "/console/extrade101/tradeCountShowByDay/"+date+",5",
                dataType: 'json',
    ...
    function query3_2(){
    	var date = new Date(getLastDayMills()).format("yyyy-MM-dd");
    	var req = "/console/extrade102/tradeCountShowByDay/"+date+",5";
    	//.log(req)
