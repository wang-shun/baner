var chart6;
    ...
    function query6() {
    	...
    	//var it101=Restful.find("/console/extrade101/totalShow/"+date+",5",null)
    	//var it102=Restful.find("/console/extrade102/totalShow/"+date+",5",null)
    	var count=0;
	var datas=[];
    	for(var i=1;i<=2;i++){
    	var req="/console/extrade10"+i+"/totalShow/"+date+",5";
    		$.ajax({
                type: 'get',
                url: req,
                dataType: 'json',
