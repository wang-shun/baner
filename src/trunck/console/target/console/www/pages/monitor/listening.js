...
//            },
        ...
        function(data) {
        	...
        	var data1=Restful.find("/console/extrade101/tradeTodayAmt/"+date,null);
        	var data2=Restful.find("/console/extrade102/tradeTodayAmt/"+date,null);
        	var money1="0/0￥";
    ...
    function risk(){
    	var data4=Restful.find("/console/exsysoplogs/getLogs",null);
    	var map = new Map();
    	$("#risk").empty();
