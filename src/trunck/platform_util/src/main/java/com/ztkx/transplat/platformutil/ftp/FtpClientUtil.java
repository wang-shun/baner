package com.ztkx.transplat.platformutil.ftp;
...
//		BaseConfig config = BaseConfig.getInstence("E:/svn_workspack/transplat/src/trunck/platform_util/config/baseConf.properties");
